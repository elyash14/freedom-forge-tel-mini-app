export type Dictionary = {
  ...
  settings: {
    ...
    tabPersonalAssets: string;
    tabAdminAssets: string;
    settingsTabsLabel: string;
    themeLabel: string;
    themeTelegram: string;
    themeLight: string;
    themeDark: string;
    themeSystem: string;
    personalAssetsSection: string;
    personalAssetsHint: string;
    addPersonalAsset: string;
    adminAssetsSection: string;
    adminAssetsHint: string;
    adminOnlyBadge: string;
    adminAssetRowHint: string;
    drawerDetailsTab: string;
    drawerHistoryTab: string;
